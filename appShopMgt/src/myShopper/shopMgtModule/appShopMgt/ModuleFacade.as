package myShopper.shopMgtModule.appShopMgt
{
	...
	import myShopper.shopMgtModule.appShopMgt.controller.ButtonCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.CommCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.FileCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.LoginCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.StartupCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.StatusCommand;
	import myShopper.shopMgtModule.appShopMgt.controller.WindowCommand;
	...
	public class ModuleFacade extends PipeAwardModule implements IPipeAwareModule
	{
		...
		override protected function initializeController( ) : void
		{
			...
			//registerCommand( WindowEvent.CREATE, 				WindowCommand );
			registerCommand( WindowEvent.CLOSE, 				WindowCommand );
			registerCommand( ShopMgtEvent.LOGIN, 				LoginCommand );
			registerCommand( ShopMgtEvent.SHOP_UPDATE_STATUS, 	StatusCommand );
