package myShopper.shopMgtModule.appShopMgt.view
{
	...
	public class ModuleJunctionMediator extends JunctionMediator
	{
		...
		public static const NAME:String = ShopMgtMain.NAME + 'JunctionMediator';
		...
		override public function handlePipeMessage(message:IPipeMessage):void
		{
			...
			junction.sendMessage(PipeID.MODULE_TO_APP, new Message(Message.NORMAL, null, 'message from shop mgt main'));
		}		
	}
}