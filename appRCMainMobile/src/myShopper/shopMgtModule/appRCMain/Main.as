package myShopper.shopMgtModule.appRCMain
{
	...
	{
		[Embed(source = "../../../../../../../asset/assetMain/RCScreenMobile.swf")]
		private var Screen:Class;
		
		private var mcScreen:MovieClip;
		
		[Embed(source="../../../../../../../../xml/shop-management/shopMgtRCConfig-mobile.xml", mimeType="application/octet-stream")]
		...
		private function loaderEventHandler(e:FileEvent):void 
		{
			...
			var vo:SetupVO = new SetupVO('setup', new AssetManager(), new XMLManager(), new SettingManager(), new ServiceManager(), new VOManager(), '', '',new SoundManager());
