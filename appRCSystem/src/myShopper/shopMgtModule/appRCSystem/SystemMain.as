package myShopper.shopMgtModule.appRCSystem
{
	...
	{
		public static const NAME:String = 'systemRCMain';
		...
		override public function setup(inContainer:DisplayObjectContainer, inVO:IVO = null):Boolean 
		{
			...
			var setupVO:SetupVO = (inVO is SetupVO) ? inVO as SetupVO : new SetupVO('setup', new AssetManager(), new XMLManager(), new SettingManager(), new ServiceManager(), new VOManager(), '', '', new SoundManager());
			...
			if ( super.setup(_rootContainer, setupVO) )
			{
				...
				soundManager.addAsset(assetManager, null);
