package myShopper.shopMgtModule.appForm.view 
{
	...
	import myShopper.fl.shopMgt.form.ShopMgtPasswordForm;
	...
	public class ShopPasswordFormMediator extends ApplicationMediator implements IContainerMediator, ITabFormMediator 
	{
		...
		private var form:ShopMgtPasswordForm;
		private var _window:BaseWindow;
		//private var _bg:ApplicationDisplayObject;
		
		public function ShopPasswordFormMediator(inMediatorName:String = null, inViewComponent:IModuleMain = null) 
		{
		...
		{
			return [NotificationType.ADD_FORM_SHOP_PASSWORD, NotificationType.UPDATE_PASSWORD_FAIL, NotificationType.UPDATE_PASSWORD_SUCCESS];
		}
		...
		override public function handleNotification(note:INotification):void 
		{
			...
			switch(note.getName())
			{
				case NotificationType.ADD_FORM_SHOP_PASSWORD:
				{
					...
					if (_window)
					{
						...
						form = _window.addApplicationChild(vo.displayObject, null) as ShopMgtPasswordForm;
				...
				case NotificationType.UPDATE_PASSWORD_SUCCESS:
				{
					createFormAlert(MessageID.SUCCESS_SAVE, form.txtOldPassword);
					//startListener();
					break;
				}
				case NotificationType.UPDATE_PASSWORD_FAIL:
				{
					...
					createFormAlert(getMessage(MessageID.ERROR_GET_DATA) + '\n' + getMessage(MessageID.ERROR_TRY_LATER), form.txtOldPassword);
					startListener()
					break;
				}
			}
			...
			switch(e.targetButton)
			{
				...
				case form.btnSend:
				{
					...
					if (result === true)
					{
						...
						sendNotification(ShopMgtEvent.SHOP_UPDATE_PASSWORD);
					}
					else
					{
