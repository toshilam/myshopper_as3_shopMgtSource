package myShopper.shopMgtModule.appForm.model
{
	...
	public class ShopSettingInfoProxy extends ApplicationProxy implements IRemoteDataProxy
	{
		...
		public function ShopSettingInfoProxy(inName:String, inData:Object)
		{
			super( inName, inData );
		}
		...
		override public function onRegister():void
		{
			...
			_targetNode = windowNode.*.(@id == AssetID.BTN_SHOP_SETTING)[0];
		}
